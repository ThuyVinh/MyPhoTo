...
namespace MyAlbumEditor
{
    public partial class EditorForm : Form
    {
        ...
        {
            comboAlbums.DataSource = Directory.GetFiles(AlbumManager.DefaultPath,
                                                        "*.abm");
        ...
        private void DisplayAlbum()
        {
            ...
            else
            {
                ...
                if (Manager.Album.PhotoDescriptor == PhotoAlbum.PhotoAlbum.DescriptorOption.DateTaken)
                    lstPhotos.FormatString = "dMMMM dd, yyyy";

                lstPhotos.BeginUpdate();
                lstPhotos.Items.Clear();
                foreach (Photo p in Manager.Album)
                {
