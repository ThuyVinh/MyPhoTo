...
namespace Photo
{
    public partial class SlideShowDialog : Form
    {
        ...
        {
            if (manager == null || manager.Album == null
            || manager.Album.Count == 0)
        ...
        private void InitializeForm()
        {
            ...
            Bitmap bmp = Photo.Properties.Resources.NextBitmap;
            bmp.MakeTransparent(Color.White);
            btnNext.Image = bmp;

            bmp = Photo.Properties.Resources.PrevBitmap;
            bmp.MakeTransparent(Color.White);
            btnPrev.Image = bmp;
            ...
            _soundPlayer = new SoundPlayer(
                Photo.Properties.Resources.DingSound);
        }
