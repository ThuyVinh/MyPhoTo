...
"ScrollablePictureBox.bmp")]
    public class ScrollablePictureBox : PictureBox
    {
        ...
        {
            // Initializehorizontal scroll bar
            HBar.Visible = false;
...
PaintEventArgs e)
        {
            base.OnPaint(e);
            if (Image != null
&& (HBar.Visible || VContainer.Visible))
...
!= PictureBoxSizeMode.Normal))
        ...
        protected override void OnSizeModeChanged(
EventArgs e)
        {
        ...
        private void ResetScrollBars()
        {
            ...
            if (Image != null && ScrollingActive())
            {
                ...
                == PictureBoxSizeMode.CenterImage)
                {
                    HBar.Value = Math.Abs(Image.Width / 2
                    - ClientSize.Width / 2);
                    VBar.Value = Math.Abs(Image.Height / 2
                    - ClientSize.Height / 2);
                }
            }
        }
